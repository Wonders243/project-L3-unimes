...
SECRET_KEY = 'django-insecure-=v)x=cpc$^80t#!k^4egj^g5q95%2s=w+6-f7q%++dnh&kj$m7'
...
INSTALLED_APPS = [
    ...
    'animation',  # L'application pour l'animation
]
...
DATABASES = {
    'default': {
        ...
        'NAME': BASE_DIR / 'db.sqlite3',  # Cette ligne est correcte pour SQLite
    }
}
